...
class SeasonManager:
    ...
    FACTION_EFFECTS = [
        ...
        # 2 = Лето
        {
            'Аркадия':  {'stat': 0.65,  'cost': 1.25},   # -15% атак/защита, +10% стоимости
            'Селестия': {'stat': 0.90,  'cost': 1.17},   # -3% атак/защита, +7% стоимости
            'Хиперион': {'stat': 1.25,  'cost': 0.65},   # +15% атак/защита, -10% стоимости
            'Этерия':   {'stat': 0.97,  'cost': 1.00},   # -3% атак/защита, нет эффекта стоимости
            'Халидон':  {'stat': 1.45,  'cost': 0.65},   # +45% атак/защита, -15% стоимости
        },
        # 3 = Осень
        {
            'Аркадия':  {'stat': 0.97,  'cost': 1.00},   # -3% атак/защита, нет эффекта стоимости
            'Селестия': {'stat': 0.65,  'cost': 1.25},   # -15% атак/защита, +10% стоимости
            'Хиперион': {'stat': 0.90,  'cost': 1.17},   # -3% атак/защита, +7% стоимости
            'Этерия':   {'stat': 1.25,  'cost': 0.65},   # +15% атак/защита, -10% стоимости
            'Халидон':  {'stat': 0.90,  'cost': 1.17},   # -3% атак/защита, +7% стоимости
        },
    ]
