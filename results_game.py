...
class ResultsGame:
    ...
    def calculate_military_rank(self):
        ...
        rank_table = [
            ("Главнокомандующий", 30000),
            ("Верховный маршал", 24000),
            ("Генерал-фельдмаршал", 18000),
            ("Генерал армии", 14500),
            ("Генерал-полковник", 11500),
            ("Генерал-лейтенант", 9800),
            ("Генерал-майор", 7800),
            ("Бригадный генерал", 6400),
            ("Коммандер", 5000),
            ("Полковник", 4000),
            ("Подполковник", 3500),
            ("Капитан-лейтенант", 2700),
            ("Капитан", 2000),
